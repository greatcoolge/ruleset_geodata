...
⑪ `geosite,media,🌍 国外媒体` 源采用 [v2fly/domain-list-community/category-entertainment](https://github.com/v2fly/domain-list-community/blob/master/data/category-entertainment) 和 [blackmatrix7/ios_rule_script/GlobalMedia](https://github.com/blackmatrix7/ios_rule_script/tree/master/rule/Clash/GlobalMedia) 组合  
...
<table>
  ...
  <tr>
    <td>geosite.dat</td>
    <td><code>fakeip-filter</code>、<code>fakeip-filter-lite</code>、<code>private</code>、<code>ads</code>、<code>trackerslist</code>、<code>microsoft-cn</code>、<code>apple-cn</code>、<code>google-cn</code>、<code>games-cn</code>、<del><code>media</code></del>、<code>ai</code>、<code>networktest</code>、<code>tld-proxy</code>、<code>proxy</code>、<code>tld-cn</code> 和 <code>cn</code></td>
...
㉑ `rule-set,media,🌍 国外媒体` 源采用 [v2fly/domain-list-community/category-entertainment](https://github.com/v2fly/domain-list-community/blob/master/data/category-entertainment) 和 [blackmatrix7/ios_rule_script/GlobalMedia](https://github.com/blackmatrix7/ios_rule_script/tree/master/rule/Clash/GlobalMedia) 组合  
